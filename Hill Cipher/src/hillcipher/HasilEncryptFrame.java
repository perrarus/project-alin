...
public class HasilEncryptFrame extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(HasilEncryptFrame.class.getName());
    ...
    /**
     * Creates new form HasilEncryptFrame
     */
    public HasilEncryptFrame(String plaintext, String ciphertext, int[][] keyMatrix, int matrixSize) {
    ...
    public HasilEncryptFrame(String plaintext, String ciphertext, int[][] keyMatrix, int matrixSize, List<String> steps) {
        this.plaintext = plaintext;
        this.ciphertext = ciphertext;
        this.keyMatrix = keyMatrix;
        this.matrixSize = matrixSize;
    ...
    public HasilEncryptFrame(String plaintext, String ciphertext, int[][] keyMatrix, int matrixSize, List<String> steps, int paddingCount) {
        this.plaintext = plaintext;
        this.ciphertext = ciphertext;
        this.keyMatrix = keyMatrix;
        this.matrixSize = matrixSize;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HASIL ENCRYPT");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Proses Encryption", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bahnschrift", 1, 14))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Hasil Encryption", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bahnschrift", 1, 14))); // NOI18N
